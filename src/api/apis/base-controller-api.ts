...
export const BaseControllerApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async index1(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<string>>> {
            const localVarAxiosArgs = await BaseControllerApiAxiosParamCreator(configuration).index1(options);
...
export const BaseControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async index1(options?: AxiosRequestConfig): Promise<AxiosResponse<string>> {
            return BaseControllerApiFp(configuration).index1(options).then((request) => request(axios, basePath));
        },
    };
};
...
export class BaseControllerApi extends BaseAPI {
     ...
     */
    public async index1(options?: AxiosRequestConfig) : Promise<AxiosResponse<string>> {
        return BaseControllerApiFp(this.configuration).index1(options).then((request) => request(this.axios, this.basePath));
    }
}
